...
The canonical reader accepts schema 1.0 and 2.0. Historical fields are not synthesized. Schema 2.0 stores collection bounds and method results; inspect statuses and retained cohorts before using a number. See [result interpretation](manual/05-results.md).
