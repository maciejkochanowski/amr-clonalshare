...
The attribution support fraction is the share of retained isolates in lineages with at least two members. Below 0.90, the output is flagged as unsupported. Fewer than ten lineages and dominant-lineage concentration also require attention. A wider population interval is not a general remedy for a small or selective collection. Historical validation contains substantial failures under sparse, nonnormal and latent-target settings.
