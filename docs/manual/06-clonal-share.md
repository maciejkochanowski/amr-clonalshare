...
The attribution support fraction is the share of retained isolates in lineages with at least two members. Below 0.80 the score is withheld from the report (status `unavailable`) and kept in the result record as a diagnostic. Fewer than ten lineages and dominant-lineage concentration also require attention. A wider population interval is not a general remedy for a small or selective collection. The validation grid records substantial undercoverage in sparse, non-normal and latent-target settings.
