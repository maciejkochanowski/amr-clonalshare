...
floor set for it, and a module that falls under its floor
...
FLOORS = {
    "_population_probit_numerics": 95,
    "population_probit": 95,
    ...
    "latent": 85,
    "stats": 80,
    # Three lines that decide which random stream every estimate is drawn
    # from; they run on every analysis and a gap there would be invisible.
    "_seeding": 90,
    "phenotype": 60,
