...
#       amr-clonalshare:1.0.0 --config /data/config.yaml --results-dir /data/out
FROM python:3.11.15-slim-bookworm

LABEL org.opencontainers.image.title="amr-clonalshare"
LABEL org.opencontainers.image.version="1.0.0"
LABEL org.opencontainers.image.licenses="MIT"
LABEL org.opencontainers.image.description="The share of an antimicrobial resistance phenotype that the lineages of a bacterial collection carry; pinned stack for the shipped example records"
