...
Isolates in the phenotype table: 7049; antimicrobials with a readable call: 22.

## Antimicrobials

Antimicrobials with at least 20 isolates of the rarer outcome: 17 of 22. Below that number the estimate is still computed, but its interval will be wide and the report says so.
...
Share of isolates in lineages of at least 2 (support): 99.7 %; the estimator needs 90.0 %. The clonal share can be estimated on this cohort.
