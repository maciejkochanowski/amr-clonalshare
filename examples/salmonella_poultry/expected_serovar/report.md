...
- **Run:** CAFAD46F
- **Issued:** 2026-09-25T15:22Z
- **Software:** amr-clonalshare 1.0.0
- **Isolates:** 7049
- **Lineage:** serovar
- **Seed:** 42
- **Configuration:** sha256:33ec36f0abc3
- **Record digest:** sha256:c1823ec0264640e33453271b4d188724c9c28069519420348b205a0f962bb544
...
|---|---:|---:|---:|---:|---|---|
| nalidixic acid | 0.766 | 0.033 to 0.853 | -0.01 | 1.0 × 10¹⁴³ |  | evidence of a lineage effect |
| ciprofloxacin | 0.666 | 0.068 to 0.798 | -0.01 | 7.4 × 10¹³⁷ |  | evidence of a lineage effect |
| sulfisoxazole | 0.479 | 0.116 to 0.655 | -0.01 | 9.8 × 10¹⁶⁵ |  | evidence of a lineage effect |
| streptomycin | 0.365 | 0.113 to 0.484 | -0.01 | 3.3 × 10¹²⁸ |  | evidence of a lineage effect |
| chloramphenicol | 0.345 | 0.001 to 0.401 | -0.01 | 7.9 × 10⁷⁰ |  | evidence of a lineage effect |
| tetracycline | 0.335 | 0.191 to 0.527 | -0.01 | 4.9 × 10¹³¹ |  | evidence of a lineage effect |
| ceftazidime | 0.288 | -0.198 to 0.423 | -0.17 | 6.9 | ‡ | no detectable lineage effect |
| trimethoprim-sulfamethoxazole | 0.276 | 0.001 to 0.298 | -0.01 | 2.2 × 10⁵⁰ |  | evidence of a lineage effect |
| ceftriaxone | 0.234 | 0.038 to 0.322 | -0.01 | 8.7 × 10⁷³ |  | evidence of a lineage effect |
| ceftiofur | 0.225 | 0.056 to 0.343 | -0.02 | 9.1 × 10³⁷ |  | evidence of a lineage effect |
| sulfamethoxazole | 0.211 | -0.112 to 0.390 | -0.10 | 135.1 | ‡ | lineage effect selected by e-BH; its size is not resolved |
| cefoxitin | 0.210 | 0.028 to 0.340 | -0.01 | 4.9 × 10⁵⁵ |  | evidence of a lineage effect |
| gentamicin | 0.202 | 0.084 to 0.269 | -0.01 | 5.7 × 10⁶³ |  | evidence of a lineage effect |
| ampicillin | 0.193 | 0.092 to 0.255 | -0.01 | 9.8 × 10⁶⁹ |  | evidence of a lineage effect |
| amoxicillin-clavulanic acid | 0.193 | 0.062 to 0.281 | -0.01 | 3.7 × 10⁶³ |  | evidence of a lineage effect |
| kanamycin | 0.118 | 0.068 to 0.182 | -0.02 | 8.8 × 10¹⁵ |  | evidence of a lineage effect |
| amikacin | 0.024 | 0.022 to 0.024 | -0.03 | 0.6 |  | interval excludes zero; not selected by e-BH |
| azithromycin | 0.021 | -0.026 to 0.034 | -0.02 | 423.2 | ‡ | lineage effect selected by e-BH; its size is not resolved |
...
Lineage groups in the input: 85, of which 20 hold a single isolate. Support 99.7 % against the 80.0 % the estimator needs: accepted.

*Figure 1 (drawn on the page).* Isolates per lineage, largest first, the 40 largest of 85. A lineage of one isolate, drawn in orange, cannot be predicted out of sample and counts against support; support is the share of isolates in the other lineages, 99.7 % here against the 80.0 % the estimator requires. The largest lineage holds 19.9 % of the isolates, which sets how much one lineage can weigh in the share.

**Table 2.** Conditions the estimator requires before any result is reported.

| Condition | Observed | Required | Verdict |
|---|---:|---:|---|
| Lineage support, lowest over the antimicrobials read | 96.2 % | ≥ 80.0 % | accepted |
...
|---|---:|---:|---:|---:|
| nalidixic acid | 0.766 | 0.033 to 0.853 | 0.782 (0.036 to 0.864) | 0.957 (0.098 to 0.983) |
| ciprofloxacin | 0.666 | 0.068 to 0.798 | 0.686 (0.074 to 0.812) | 0.911 (0.184 to 0.968) |
| sulfisoxazole | 0.479 | 0.116 to 0.655 | 0.501 (0.125 to 0.675) | 0.702 (0.197 to 0.867) |
| streptomycin | 0.365 | 0.113 to 0.484 | 0.384 (0.121 to 0.504) | 0.547 (0.179 to 0.692) |
| chloramphenicol | 0.345 | 0.001 to 0.401 | 0.365 (0.002 to 0.455) | 0.670 (0.005 to 0.728) |
| tetracycline | 0.335 | 0.191 to 0.527 | 0.355 (0.205 to 0.549) | 0.503 (0.296 to 0.737) |
| ceftazidime | 0.288 | -0.198 to 0.423 | 0.339 (0.000 to 0.573) | 0.463 (0.000 to 0.639) |
| trimethoprim-sulfamethoxazole | 0.276 | 0.001 to 0.298 | 0.294 (0.001 to 0.376) | 0.644 (0.006 to 0.670) |
| ceftriaxone | 0.234 | 0.038 to 0.322 | 0.251 (0.041 to 0.342) | 0.453 (0.091 to 0.577) |
| ceftiofur | 0.225 | 0.056 to 0.343 | 0.242 (0.062 to 0.365) | 0.426 (0.125 to 0.593) |
| sulfamethoxazole | 0.211 | -0.112 to 0.390 | 0.237 (0.000 to 0.455) | 0.371 (0.000 to 0.620) |
| cefoxitin | 0.210 | 0.028 to 0.340 | 0.225 (0.031 to 0.361) | 0.447 (0.080 to 0.628) |
| gentamicin | 0.202 | 0.084 to 0.269 | 0.217 (0.091 to 0.287) | 0.393 (0.182 to 0.495) |
| ampicillin | 0.193 | 0.092 to 0.255 | 0.207 (0.099 to 0.272) | 0.326 (0.161 to 0.420) |
| amoxicillin-clavulanic acid | 0.193 | 0.062 to 0.281 | 0.207 (0.067 to 0.300) | 0.363 (0.130 to 0.497) |
| kanamycin | 0.118 | 0.068 to 0.182 | 0.128 (0.075 to 0.197) | 0.254 (0.155 to 0.366) |
| amikacin | 0.024 | 0.022 to 0.024 | 0.026 (0.015 to 0.042) | 0.427 (0.420 to 0.431) |
| azithromycin | 0.021 | -0.026 to 0.034 | 0.024 (0.000 to 0.049) | 0.236 (0.000 to 0.308) |
...
|---|---:|---:|---|
| sulfisoxazole | 9.8 × 10¹⁶⁵ | 382.20 | yes |
| nalidixic acid | 1.0 × 10¹⁴³ | 329.28 | yes |
| ciprofloxacin | 7.4 × 10¹³⁷ | 317.45 | yes |
| tetracycline | 4.9 × 10¹³¹ | 303.24 | yes |
| streptomycin | 3.3 × 10¹²⁸ | 295.92 | yes |
| ceftriaxone | 8.7 × 10⁷³ | 170.25 | yes |
| chloramphenicol | 7.9 × 10⁷⁰ | 163.25 | yes |
| ampicillin | 9.8 × 10⁶⁹ | 161.16 | yes |
| gentamicin | 5.7 × 10⁶³ | 146.80 | yes |
| amoxicillin-clavulanic acid | 3.7 × 10⁶³ | 146.37 | yes |
| cefoxitin | 4.9 × 10⁵⁵ | 128.24 | yes |
| trimethoprim-sulfamethoxazole | 2.2 × 10⁵⁰ | 115.93 | yes |
| ceftiofur | 9.1 × 10³⁷ | 87.40 | yes |
| kanamycin | 8.8 × 10¹⁵ | 36.72 | yes |
| azithromycin | 423.2 | 6.05 | yes |
| sulfamethoxazole | 135.1 | 4.91 | yes |
| ceftazidime | 6.9 | 1.93 | no |
...
- **Seed:** 42
- **Configuration:** `sha256:33ec36f0abc3`
- **Record:** `sha256:c1823ec0264640e33453271b4d188724c9c28069519420348b205a0f962bb544`
...
amr-clonalshare 1.0.0 · record schema 1.0 · seed 42 · configuration sha256:33ec36f0abc3
Cite this run as: “amr-clonalshare 1.0.0, run CAFAD46F, record sha256:c1823ec02646.”
