...
SNP cluster, with the budgets of the reference reading (five folds, ten
...
serovar run returns 0.766 (0.009 to 0.852) and the cluster run 0.935 (0.234
to 0.976), against 0.766 (0.016 to 0.853) and 0.935 (0.247 to 0.977) in
the reference reading, with the permuted control near zero at both; the
...
Kitagawa split between the periods. Neither is part of the reference reading
