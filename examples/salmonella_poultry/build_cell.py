#!/usr/bin/env python3
"""Cut the poultry-meat *Salmonella* cell out of one NCBI
...
and antimicrobial, with S written as 0 and I or R as 1 (non-susceptible),
the reading NCBI applies to its own calls. Nothing is
