...
# The cohort's calls are wild type or non-wild-type against a cut-off, not a
# clinical category, and are written in that vocabulary; DATA_PROVENANCE.md
# names the cut-off of every agent.
CALL = {0: "WT", 1: "NWT"}
