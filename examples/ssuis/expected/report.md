...
- **Seed:** 42
- **Configuration:** sha256:e0970c46eb3f
- **Record digest:** sha256:7aee2b77ec409eec91696a2c40f613b821dedfe0407624c0ef80934d15776211

**16 antimicrobials; 81 analysis outcomes.** 72 computed, 0 full ranges, 9 unavailable or incomplete. Each result retains its own target and data subset.
...
**Gates.** 72 computed, 0 full ranges, 9 unavailable or incomplete. Each result retains its own target and data subset. A withheld value failed a declared reporting condition of its estimator; the recorded reason distinguishes input limitations from numerical failure. Passing a gate does not verify the model.
...
| amoxicillin | censored_mic / computation_incomplete | moment iteration limit reached; point retained for diagnostics only; 11 of 30 lineages lie wholly beyond the panel, holding 19% of isolates, which the historical calibration placed inside the range where the shrinkage absorbs them | Inspect the recorded numerical or resource failure and method diagnostics before retrying in a new output directory. |
...
| erythromycin | censored_mic / computed | 4 of 30 lineages lie wholly beyond the panel, holding 2% of isolates, which the historical calibration placed inside the range where the shrinkage absorbs them | Read the interval kind, assumptions and retained cohort before comparing results. |
| florfenicol | censored_mic / computed | ok | Read the interval kind, assumptions and retained cohort before comparing results. |
| lincomycin | censored_mic / computed | 7 of 30 lineages lie wholly beyond the panel, holding 5% of isolates, which the historical calibration placed inside the range where the shrinkage absorbs them | Read the interval kind, assumptions and retained cohort before comparing results. |
| marbofloxacin | censored_mic / computed | ok | Read the interval kind, assumptions and retained cohort before comparing results. |
| penicillin | censored_mic / computed | 4 of 30 lineages lie wholly beyond the panel, holding 8% of isolates, which the historical calibration placed inside the range where the shrinkage absorbs them | Read the interval kind, assumptions and retained cohort before comparing results. |
| spectinomycin | censored_mic / computed | 1 of 30 lineages lie wholly beyond the panel, holding 0% of isolates, which the historical calibration placed inside the range where the shrinkage absorbs them | Read the interval kind, assumptions and retained cohort before comparing results. |
| tetracycline | censored_mic / computed | ok | Read the interval kind, assumptions and retained cohort before comparing results. |
| tiamulin | censored_mic / computed | 3 of 30 lineages lie wholly beyond the panel, holding 1% of isolates, which the historical calibration placed inside the range where the shrinkage absorbs them | Read the interval kind, assumptions and retained cohort before comparing results. |
...
| tylosin | censored_mic / computed | 6 of 30 lineages lie wholly beyond the panel, holding 4% of isolates, which the historical calibration placed inside the range where the shrinkage absorbs them | Read the interval kind, assumptions and retained cohort before comparing results. |
...
|---|---:|---:|---:|---:|---|---|
| penicillin | 0.513 | 0.235 to 0.683 | -0.06 | 5.0 × 10¹⁷ |  | evidence of a lineage effect |
| ceftiofur | 0.506 | 0.264 to 0.682 | -0.06 | 2.8 × 10¹⁹ |  | evidence of a lineage effect |
| tiamulin | 0.398 | 0.216 to 0.540 | -0.06 | 1.1 × 10¹³ |  | evidence of a lineage effect |
| trimethoprim | 0.306 | 0.173 to 0.403 | -0.06 | 2.5 × 10¹⁰ |  | evidence of a lineage effect |
| amoxicillin | 0.238 | -0.038 to 0.488 | -0.06 | 5.6 × 10⁴ | ‡ | lineage effect selected by e-BH; its size is not resolved |
| lincomycin | 0.235 | 0.111 to 0.367 | -0.06 | 6.3 × 10⁷ |  | evidence of a lineage effect |
| cefquinome | 0.185 | -0.044 to 0.390 | -0.06 | 1.5 × 10³ | ‡ | lineage effect selected by e-BH; its size is not resolved |
| erythromycin | 0.169 | 0.070 to 0.274 | -0.06 | 2.2 × 10⁵ |  | evidence of a lineage effect |
| tylosin | 0.154 | 0.065 to 0.270 | -0.06 | 6.9 × 10⁴ |  | evidence of a lineage effect |
| tilmicosin | 0.146 | 0.065 to 0.260 | -0.05 | 5.6 × 10⁴ |  | evidence of a lineage effect |
| spectinomycin | 0.130 | -0.058 to 0.336 | -0.06 | 1.5 × 10³ | ‡ | lineage effect selected by e-BH; its size is not resolved |
| doxycycline | 0.030 | -0.046 to 0.066 | -0.06 | 3.6 | ‡ | no detectable lineage effect |
| tetracycline | 0.028 | -0.044 to 0.071 | -0.06 | 2.1 | ‡ | no detectable lineage effect |
...
>
> For doxycycline and tetracycline, no lineage effect is distinguishable from none in this collection at the chosen resolution. This does not establish independence from lineage or identify the reason for a prevalence change.
>
...
|---|---:|---:|---:|---:|
| penicillin | 0.513 | 0.235 to 0.683 | 0.254 to 0.705 | 0.751 (0.402 to 0.893) |
| ceftiofur | 0.506 | 0.264 to 0.682 | 0.284 to 0.704 | 0.741 (0.440 to 0.892) |
| tiamulin | 0.398 | 0.216 to 0.540 | 0.234 to 0.595 | 0.637 (0.387 to 0.787) |
| trimethoprim | 0.306 | 0.173 to 0.403 | 0.188 to 0.496 | 0.488 (0.290 to 0.615) |
| amoxicillin | 0.238 | -0.038 to 0.488 | 0.000 to 0.513 | 0.542 (0.000 to 0.811) |
| lincomycin | 0.235 | 0.111 to 0.367 | 0.122 to 0.399 | 0.369 (0.179 to 0.553) |
| cefquinome | 0.185 | -0.044 to 0.390 | 0.000 to 0.447 | 0.495 (0.000 to 0.747) |
| erythromycin | 0.169 | 0.070 to 0.274 | 0.077 to 0.310 | 0.264 (0.111 to 0.418) |
| tylosin | 0.154 | 0.065 to 0.270 | 0.071 to 0.291 | 0.240 (0.102 to 0.412) |
| tilmicosin | 0.146 | 0.065 to 0.260 | 0.071 to 0.280 | 0.228 (0.102 to 0.398) |
| spectinomycin | 0.130 | -0.058 to 0.336 | 0.000 to 0.360 | 0.288 (0.000 to 0.605) |
| doxycycline | 0.030 | -0.046 to 0.066 | 0.000 to 0.110 | 0.066 (0.000 to 0.141) |
| tetracycline | 0.028 | -0.044 to 0.071 | 0.000 to 0.095 | 0.062 (0.000 to 0.152) |
...
|---|---:|---:|---|
| ceftiofur | 2.8 × 10¹⁹ | 44.77 | yes |
| penicillin | 5.0 × 10¹⁷ | 40.76 | yes |
| tiamulin | 1.1 × 10¹³ | 30.01 | yes |
| trimethoprim | 2.5 × 10¹⁰ | 23.93 | yes |
| lincomycin | 6.3 × 10⁷ | 17.96 | yes |
| erythromycin | 2.2 × 10⁵ | 12.28 | yes |
| tylosin | 6.9 × 10⁴ | 11.14 | yes |
| tilmicosin | 5.6 × 10⁴ | 10.94 | yes |
| amoxicillin | 5.6 × 10⁴ | 10.92 | yes |
| spectinomycin | 1.5 × 10³ | 7.33 | yes |
| cefquinome | 1.5 × 10³ | 7.32 | yes |
| doxycycline | 3.6 | 1.27 | no |
| tetracycline | 2.1 | 0.72 | no |
...
*Figure 5 (drawn on the page).* Share of the dilution scale carried by lineage, per agent, 16 largest of 16: point estimate with the 95 % interval for the Gaussian population model (thin) and the realised interval for these lineages (thick); an agent whose reading is refused is drawn in grey. The hollow diamond is the share of the binary call from Table 1 for the same agent, a different quantity whose retained isolates may differ, placed here so that the two readings can be seen side by side. The figure in parentheses at the right is the share of readings at an end well, which enter as censored.
...
|---|---|---:|---:|---:|---:|
| Canada | amoxicillin | 205 | 0.279 | -0.028 to 0.555 | not computed |
| Canada | cefquinome | 205 | 0.198 | -0.052 to 0.506 | not computed |
| Canada | ceftiofur | 205 | 0.493 | 0.215 to 0.647 | not computed |
| Canada | doxycycline | 205 | -0.001 | -0.170 to 0.111 | not computed |
| Canada | enrofloxacin |  | not computed |  | not computed |
| Canada | erythromycin | 205 | 0.220 | 0.020 to 0.314 | not computed |
| Canada | florfenicol |  | not computed |  | not computed |
| Canada | lincomycin | 205 | 0.230 | 0.057 to 0.323 | not computed |
| Canada | marbofloxacin |  | not computed |  | not computed |
| Canada | penicillin | 205 | 0.553 | 0.223 to 0.745 | not computed |
| Canada | spectinomycin | 205 | 0.047 | -0.172 to 0.157 | not computed |
| Canada | tetracycline | 205 | 0.077 | 0.003 to 0.152 | not computed |
| Canada | tiamulin | 205 | 0.430 | 0.141 to 0.572 | not computed |
| Canada | tilmicosin | 205 | 0.180 | 0.001 to 0.294 | not computed |
| Canada | trimethoprim | 205 | 0.352 | 0.159 to 0.514 | not computed |
| Canada | tylosin | 205 | 0.194 | 0.011 to 0.317 | not computed |
| United Kingdom | amoxicillin | 423 | 0.233 | 0.026 to 0.485 | not computed |
| United Kingdom | cefquinome | 423 | 0.303 | 0.035 to 0.482 | not computed |
| United Kingdom | ceftiofur | 423 | 0.510 | 0.181 to 0.716 | not computed |
| United Kingdom | doxycycline | 423 | 0.105 | -0.039 to 0.263 | not computed |
| United Kingdom | enrofloxacin |  | not computed |  | not computed |
| United Kingdom | erythromycin | 423 | 0.221 | 0.097 to 0.363 | not computed |
| United Kingdom | florfenicol |  | not computed |  | not computed |
| United Kingdom | lincomycin | 423 | 0.350 | 0.179 to 0.558 | not computed |
| United Kingdom | marbofloxacin |  | not computed |  | not computed |
| United Kingdom | penicillin | 423 | 0.482 | 0.112 to 0.691 | not computed |
| United Kingdom | spectinomycin | 423 | 0.399 | 0.004 to 0.768 | not computed |
| United Kingdom | tetracycline | 423 | 0.099 | -0.042 to 0.270 | not computed |
| United Kingdom | tiamulin | 423 | 0.381 | 0.144 to 0.573 | not computed |
| United Kingdom | tilmicosin | 423 | 0.222 | 0.089 to 0.347 | not computed |
| United Kingdom | trimethoprim | 423 | 0.330 | 0.188 to 0.452 | not computed |
| United Kingdom | tylosin | 423 | 0.245 | 0.104 to 0.374 | not computed |
...
- **Seed:** 42
- **Configuration:** `sha256:e0970c46eb3f`
- **Record:** `sha256:7aee2b77ec409eec91696a2c40f613b821dedfe0407624c0ef80934d15776211`
...
amr-clonalshare 1.0.0 · record schema 2.0 · seed 42 · configuration sha256:e0970c46eb3f
Cite this run as: “amr-clonalshare 1.0.0, run 5C748627, record sha256:7aee2b77ec40.”
