...
---------------------------
Measured conditional on its own decision (90 cells, 10000 replicates each;
supplement section S21 of the article). Given an open gate the
...
#: measured coverage runs 0.93 to 0.95;
