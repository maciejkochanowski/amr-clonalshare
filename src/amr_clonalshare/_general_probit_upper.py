...
Research only. Probability theory covers the Monte Carlo rank construction
...
def mc_upper_bound(counts,sizes,*,seed,B=9999,grid=DEFAULT_GRID,alpha=.05,score='centrality'):
    ...
    return dict(method='gaussian_liability_'+score+'_finite_mc_upper_research',lower=0.,upper=upper,estimate=None,
