...
def _strata(cfg, ds, strain_ids, raw_panel, seed, notify) -> dict:
    ...
    for level in levels:
        ...
        record = {"schema_version": "2.0", "config": _config_record(cfg),
...
def _population_profiles(panel, raw, interval_method="fixed_v3", *, seed=42, compute=None, progress=None) -> dict:
