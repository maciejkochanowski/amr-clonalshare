...
def main(argv=None) -> int:
    ...
    parser.add_argument('--permutations', type=int, default=200,
                        help='permuted-label runs for the control and p-value, at least 1 (default 200)')
    parser.add_argument('--bootstraps', type=int, default=0,
                        help='lineage bootstrap draws per arm; 0 reports points only (default 0)')
    ...
    try:
        ...
        def writer(directory):
            ...
            contrasts = (('selection_from_a', 'Record selection into the shared frame'),
                         ('label_difference_on_common', 'Relabelling on the shared records'),
            ...
            text = ('# Matched-record lineage comparison\n\n' + result['interpretation'] + '\n\n'
                    ...
                    + '| Contrast | Difference in adjusted score |\n| --- | ---: |\n' + rows + '\n'
                    + 'The first three contrasts sum to the total difference; the residual '
