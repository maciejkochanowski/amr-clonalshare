"""Research-only restricted-nuisance profile bootstrap; approximate inference."""
...
_TABLE_PATH=Path(__file__).resolve().parents[1]/'histogram_table_research/histogram_table.py'
_SPEC=importlib.util.spec_from_file_location('frozen_histogram_bootstrap_api',_TABLE_PATH)
table_api=importlib.util.module_from_spec(_SPEC)
sys.modules[_SPEC.name]=table_api
_SPEC.loader.exec_module(table_api)
HISTOGRAM_SHA256='12e361d5a12ed468ae7d1ce517bee1bff949122f3d34488b64fb5fdf5a941b62'
NUMERICAL_SHA256='dededb84f429ba84602aef048d2642be725981dc5982719436b68d28d3927668'
