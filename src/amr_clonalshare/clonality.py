...
#: not estimable.
#:
#: The value is read off the coverage curve that
#: ``benchmarks/decomposition_calibration.py`` writes: coverage of the nominal
#: 95 % interval for the within-lineage component falls as the shared support
#: falls, and this is the lowest support, in steps of 0.1, from which the fifth
#: percentile of the cell coverages stays at or above 0.90. The composition
#: component is not gated.
