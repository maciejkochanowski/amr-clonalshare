...
WHY THIS EXISTS. The S. suis cohort is read with the lineage defined
...
all three labels, and the reported reading -- how the agents whose
...
def main() -> int:
    ...
    res = {"provenance": {"seed": SEED, "n_boot": n_boot, "n_perm": n_perm,
                          "min_repeated_lineages": MIN_REPEATED_LINEAGES,
