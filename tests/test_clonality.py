...
def test_components_are_not_estimable_when_the_collections_barely_overlap():
    # One shared lineage of three, holding a fifth of each collection. Both
    # components are still reported, because a number a reader can see is
    # better than a silence, but they are marked not estimable and the reason
    # is named: lineages seen in one collection only bias both of them.
