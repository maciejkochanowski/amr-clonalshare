"""Hard cases of the population profile: boundary endpoints, narrow interior
minima and large groups."""
import numpy as np
import pytest
...
def test_mle_finds_interior_dip_between_coarse_grid_points():
