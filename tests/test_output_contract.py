...
def mic_record():
    return {'schema_version': '2.0', 'seed': 1, 'config': {}, 'n_isolates': 8,
...
def test_canonical_csv_preserves_unavailable_mic_and_schema1(tmp_path):
...
def test_run_schema2_carries_bounds_and_canonical_rows(share_cfg):
